    ...
    return (
        <>
            <div id="printable-area" style={{
                ...
                // width: '100%',
                minWidth: '394px', // Adjusted max-width to fit narrower barcodes
                maxWidth: '394px', // Adjusted max-width to fit narrower barcodes
                display: 'grid',
                ...
                {data?.data?.slice(1).map((row: any, index: any) => (
                    ...
                    //         // height: "230px"
                    //     }}>
                        <div key={index} className='container data-box'>
                            ...
                            <img className="barcode" src={barcodes?.[index]} alt={`Barcode ${index + 1}`} style={{ maxWidth: '100%'}} />
                            </div>
